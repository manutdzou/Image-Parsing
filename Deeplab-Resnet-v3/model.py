...
class DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        ...
        (self.feed('data')
             ...
             .batch_normalization(relu=False, name='bn2a_branch1'))
        ...
        (self.feed('pool1')
             ...
             .batch_normalization(relu=False, name='bn2a_branch2c'))
        ...
        (self.feed('bn2a_branch1', 
             ...
             .batch_normalization(relu=False, name='bn2b_branch2c'))
        ...
        (self.feed('res2a_relu', 
             ...
             .batch_normalization(relu=False, name='bn2c_branch2c'))
        ...
        (self.feed('res2b_relu', 
             ...
             .batch_normalization(relu=False, name='bn3a_branch1'))
        ...
        (self.feed('res2c_relu')
             ...
             .batch_normalization(relu=False, name='bn3a_branch2c'))
        ...
        (self.feed('bn3a_branch1', 
             ...
             .batch_normalization(relu=False, name='bn3b1_branch2c'))
        ...
        (self.feed('res3a_relu', 
             ...
             .batch_normalization(relu=False, name='bn3b2_branch2c'))
        ...
        (self.feed('res3b1_relu', 
             ...
             .batch_normalization(relu=False, name='bn3b3_branch2c'))
        ...
        (self.feed('res3b2_relu', 
             ...
             .batch_normalization(relu=False, name='bn4a_branch1'))
        ...
        (self.feed('res3b3_relu')
             ...
             .batch_normalization(relu=False, name='bn4a_branch2c'))
        ...
        (self.feed('bn4a_branch1', 
             ...
             .batch_normalization(relu=False, name='bn4b1_branch2c'))
        ...
        (self.feed('res4a_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b2_branch2c'))
        ...
        (self.feed('res4b1_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b3_branch2c'))
        ...
        (self.feed('res4b2_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b4_branch2c'))
        ...
        (self.feed('res4b3_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b5_branch2c'))
        ...
        (self.feed('res4b4_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b6_branch2c'))
        ...
        (self.feed('res4b5_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b7_branch2c'))
        ...
        (self.feed('res4b6_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b8_branch2c'))
        ...
        (self.feed('res4b7_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b9_branch2c'))
        ...
        (self.feed('res4b8_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b10_branch2c'))
        ...
        (self.feed('res4b9_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b11_branch2c'))
        ...
        (self.feed('res4b10_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b12_branch2c'))
        ...
        (self.feed('res4b11_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b13_branch2c'))
        ...
        (self.feed('res4b12_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b14_branch2c'))
        ...
        (self.feed('res4b13_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b15_branch2c'))
        ...
        (self.feed('res4b14_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b16_branch2c'))
        ...
        (self.feed('res4b15_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b17_branch2c'))
        ...
        (self.feed('res4b16_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b18_branch2c'))
        ...
        (self.feed('res4b17_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b19_branch2c'))
        ...
        (self.feed('res4b18_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b20_branch2c'))
        ...
        (self.feed('res4b19_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b21_branch2c'))
        ...
        (self.feed('res4b20_relu', 
             ...
             .batch_normalization(relu=False, name='bn4b22_branch2c'))
        ...
        conv5_3 = self.layers['res5c_relu'][0]
        shape = tf.shape(conv5_3)[1:3]

        (self.feed('res5c_relu')
             .global_avg_pool(name='fc_image_level_global_pool', keepdims=True)
             .conv(1, 1, 256, 1, 1, biased=True, relu=False, name='fc_image_level_conv_1x1')
             .resize_bilinear(shape, name='fc_image_level_interp'))

        (self.feed('res5c_relu')
             .conv(1, 1, 256, 1, 1, biased=True, relu=False, name='fc_conv_1x1_0'))

        (self.feed('res5c_relu')
             .atrous_conv(3, 3, 256, 6, padding='SAME', relu=False, name='fc_conv_3x3_1'))

        (self.feed('res5c_relu')
             .atrous_conv(3, 3, 256, 12, padding='SAME', relu=False, name='fc_conv_3x3_2'))

        (self.feed('res5c_relu')
             .atrous_conv(3, 3, 256, 18, padding='SAME', relu=False, name='fc_conv_3x3_3'))

        (self.feed('fc_image_level_interp',
                   'fc_conv_1x1_0',
                   'fc_conv_3x3_1',
                   'fc_conv_3x3_2',
                   'fc_conv_3x3_3')
             .concat(axis=-1, name='fc_feature_concat')
             .conv(1, 1, 256, 1, 1, biased=True, relu=False, padding='SAME', name='fc_conv_1x1_final')
             .conv(1, 1, num_classes, 1, 1, biased=True, relu=False, name='fc_voc12'))
