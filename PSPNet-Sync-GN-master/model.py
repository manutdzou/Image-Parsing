...
class PSPNet(Network):
    def setup(self, is_training, num_classes):
        ...
        conv5_3 = self.layers['conv5_3/relu'][0]
        ...
        (self.feed('conv5_3/relu')
             ...
             .group_normalization(relu=True, name='conv5_3_pool6_conv_gn')
        ...
        (self.feed('conv5_3/relu',
             ...
             .group_normalization(relu=True, name='conv5_4_gn')
