...
class DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        ...
        '''
        (self.feed('data')
             .conv(7, 7, 64, 2, 2, biased=False, relu=False, name='conv1') #stride 2
             .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn_conv1')
             .max_pool(3, 3, 2, 2, name='pool1') #stride 4
        ...
        (self.feed('res2c_relu')
             .conv(1, 1, 128, 2, 2, biased=False, relu=False, name='res3a_branch2a') #stride 8
        ...
        (self.feed('res3b2_relu', 
             ...
             .conv(1, 1, 1024, 2, 2, biased=False, relu=False, name='res4a_branch1')#stride 16
        ...
        (self.feed('res4b21_relu', 
             ...
             .conv(1, 1, 2048, 2, 2, biased=False, relu=False, name='res5a_branch1')#stride 32
             .batch_normalization(is_training=is_training, activation_fn=None, name='bn5a_branch1'))

        (self.feed('res4b22_relu')
             .conv(1, 1, 512, 2, 2, biased=False, relu=False, name='res5a_branch2a')#stride 32
