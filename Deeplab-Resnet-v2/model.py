...
class DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes):
        ...
        (self.feed('res5b_relu',
             ...
             .atrous_conv(3, 3, num_classes, 6, padding='SAME', relu=False, name='fc_voc12_c0'))

        (self.feed('res5c_relu')
             .atrous_conv(3, 3, num_classes, 12, padding='SAME', relu=False, name='fc_voc12_c1'))

        (self.feed('res5c_relu')
             .atrous_conv(3, 3, num_classes, 18, padding='SAME', relu=False, name='fc_voc12_c2'))

        (self.feed('res5c_relu')
             .atrous_conv(3, 3, num_classes, 24, padding='SAME', relu=False, name='fc_voc12_c3'))

        (self.feed('fc_voc12_c0',
                   'fc_voc12_c1',
                   'fc_voc12_c2',
                   'fc_voc12_c3')
             .add(name='fc_voc12'))
